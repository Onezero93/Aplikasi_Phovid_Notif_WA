                    ...
                    <div class="row">
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center"
                                style="background-image: url('{{ asset('img/logos/logo.png') }}'); background-size: cover;">
                            </div>
                        </div>
                                    ...
                                    <form action="{{ route('registrasi.proses') }}" method="POST"
                                        ...
                                        <div class="form-group mb-2 text-center">
                                            ...
                                            <label for="gambar" style="cursor: pointer;">
                                                <img id="preview-image" src="{{ asset('fotos/default.png') }}"
                                                    alt="Preview Foto" class="img-thumbnail rounded-circle"
