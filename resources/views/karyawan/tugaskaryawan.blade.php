                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card card-blog card-plain shadow-lg border-radius-xl h-100">
                                    ...
                                    <div class="position-absolute top-0 end-0 m-2">
                                        <div class="dropdown">
                                            <button class="btn btn-light btn-sm shadow-sm" type="button"
                                                id="dropdownMenuButton{{ $item->id_pemesanan }}" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                ...
                                <div class="card-body p-3 text-center">
                                    ...
                                    <p class="mb-1 text-sm">Pelanggan: <strong>{{ $item->namapelanggan }}</strong></p>
                                    <p class="mb-0 text-sm">Jadwal: <strong>{{ $item->jadwalpemotretan }}</strong></p>
