            ...
            <form id="pesanForm" action="{{ route('simpan.pesanan') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="border-radius-lg text-sm px-3 py-2 w-100" id="nomorwa" name="nomorwa"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="dp" name="tipepembayaran" value="DP"
                                    required>
                                <label class="form-check-label" for="dp">Down Payment (DP)</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="lunas" name="tipepembayaran" value="Kontan"
                                    required>
                    ...
                    <div class="mb-3" id="dpSection" style="display: none;">
                        ...
                        <input type="number" class="border-radius-lg text-sm w-100 px-3 py-2" id="jumlahdp" name="jumlahdp"
                    ...
                    <div id="buktiPembayaranSection" style="display: none;">
                        <div class="mb-3 text-center">
                            ...
                            <input type="file" class="d-none" id="buktibayar" name="gambarbuktipembayaran" accept="image/*" required>
                        </div>
                    </div>
