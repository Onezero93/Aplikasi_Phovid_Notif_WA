<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link text-dark{{ request()->is('datarekening') ? 'active bg-gradient-dark text-white' : '' }}" href="{{ url('/datarekening') }}">
        ...
        <li class="nav-item">
            <a class="nav-link text-dark {{ request()->is('datapengguna') ? 'active bg-gradient-dark text-white' : '' }}" href="{{ url('/datapengguna') }}">
