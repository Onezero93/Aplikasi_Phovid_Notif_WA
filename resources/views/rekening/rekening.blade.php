...
<div class="col-10 mx-auto">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <a href=""
                                                ...
                                                data-bs-target="#sidebarDelete{{ $rek->id_rekening }}">
                                                    ...
                                                    <form action="{{ route('rekening.perbarui', $rek->id_rekening) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                id="namabang" name="namabang"
                                                                value="{{ $rek->namabang }}" required oninput="this.value = this.value.toUpperCase();">
                                                        </div>

                                                        <div class="mb-3">
                                                            <label for="nomorrek" class="form-label">Nomor Rekening</label><br>
                                                            <input type="number"
                                                                class="border-radius-lg text-sm w-100 px-3 py-2"
    ...
    <div class="modal fade" id="tambahDataRekening" tabindex="-1" aria-labelledby="tambahPenggunaLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="border-radius-lg text-sm w-100 px-3 py-2" id="namabang"
                                    name="namabang" placeholder="Nama Bang" required oninput="this.value = this.value.toUpperCase();">
                            </div>
                            <div class="col-md-6">
